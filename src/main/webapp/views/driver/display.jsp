...
<div class="_profile">
	...
	<div
		...
		<div class="comment.star d-flex">
			...
			<jstl:if
				test="${driver.mediumStars >= 0.5 && driver.mediumStars <= 0.9 }">
				<img src="images/mediauser.png" class="comment.stars"/>
				<img src="images/vaciauser.png" class="comment.stars"/>
				<img src="images/vaciauser.png" class="comment.stars"/>
				<img src="images/vaciauser.png" class="comment.stars"/>
				<img src="images/vaciauser.png" class="comment.stars"/>
			...
			<jstl:if
				test="${driver.mediumStars >= 1 && driver.mediumStars <= 1.4 }">
			...
			<jstl:if
				test="${driver.mediumStars >= 1.5 && driver.mediumStars <= 1.9 }">
				<img src="images/enterauser.png" />
			...
			<jstl:if
				test="${driver.mediumStars >= 2 && driver.mediumStars <= 2.4 }">
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/vaciauser.png" />
				<img src="images/vaciauser.png" />
			...
			<jstl:if
				test="${driver.mediumStars >= 2.5 && driver.mediumStars <= 2.9 }">
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/mediauser.png" />
				<img src="images/vaciauser.png" />
			...
			<jstl:if
				test="${driver.mediumStars >= 3 && driver.mediumStars <= 3.4 }">
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/vaciauser.png" />
			...
			<jstl:if
				test="${driver.mediumStars >= 3.5 && driver.mediumStars <= 3.9 }">
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/mediauser.png" />
			...
			<jstl:if
				test="${driver.mediumStars >= 4 && driver.mediumStars <= 4.4 }">
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
			...
			<jstl:if
				test="${driver.mediumStars >= 4.5 && driver.mediumStars <= 4.9 }">
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
				<img src="images/enterauser.png" />
	...
	<security:authorize access="hasRole('DRIVER')">
		...
		<div class="text-center">
			<jstl:if test="${(driver.id == driverConnected.id) eq true}">
				<a class="btn btn-primary" href="driver/unsubscribe.do"
					onclick="return confirm('${confirm}')"><spring:message
						code="driver.unsubscribe" /></a>
			</jstl:if>
		</div>
	</security:authorize>
